...
/**
* com.nwsuaf.rain.SysPropHelper.java .
* ��IDL-to-Java ������ (����ֲ), �汾 "3.2"����
* ��DataService.idl
...
{
  private static String  _id = "IDL:com.nwsuaf.rain.SysProp:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      __typeCode = org.omg.CORBA.ORB.init ().create_interface_tc (SysPropHelper.id (), "com.nwsuaf.rain.SysProp");
    }
    return __typeCode;
  }
